...
compute_hrfit_logtrans <- function (data, scales, params, n=101L, per=24) {
...
compute_hrhline_logtrans <- function (data, scales, params, per=24) {
...
#' @export
#'
#' @references See post on (https://stat.ethz.ch/pipermail/bioconductor/2013-February/050725.html)
#'
#' @examples
